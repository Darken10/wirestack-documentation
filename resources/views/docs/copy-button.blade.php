...
<x-docs::demo label="Aperçu">
    <div class="flex flex-wrap gap-4 items-center">
        ...
        <x-ws::copy-button text="composer require darken10/wirestack" label="Copier" />
...
<x-docs::code>&lt;x-ws::copy-button text="composer require darken10/wirestack" /&gt;</x-docs::code>
...
<x-docs::demo>
    <div class="bg-zinc-900 rounded-xl p-4 flex items-center justify-between gap-4">
        <code class="text-sm text-zinc-100 font-mono">composer require darken10/wirestack</code>
        <x-ws::copy-button text="composer require darken10/wirestack" />
    </div>
</x-docs::demo>
