...
>
    ...
    >
        <div class="pl-3 pr-4">
            <x-heroicon-o-chevron-down class="hidden size-3! group-data-open/disclosure-button:block" />
            <x-heroicon-o-chevron-right class="block size-3! group-data-open/disclosure-button:hidden" />
        </div>
