...
Route::prefix('docs')->name('docs.')->group(function () {
    ...
    Route::get('/theming',       fn() => view('docs.theming'))->name('theming');
    Route::get('/directives',    fn() => view('docs.directives'))->name('directives');
    Route::get('/javascript-api', fn() => view('docs.javascript-api'))->name('javascript-api');
